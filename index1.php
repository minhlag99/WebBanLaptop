  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index1.php"><h2>Laptop Store<em>.Website</em></h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
			  ...
			  <a class="dropdown-toggle nav-link" data-toggle="dropdown" href="products.php" role="button" aria-haspopup="true" aria-expanded="false">
          CateGory
              ...
              <li class="nav-item">
                <a class="nav-link" href="products.php?page=1">Product</a>
              </li>
              <li class="nav-item">
