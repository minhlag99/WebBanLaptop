        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
			  ...
			  <a class="dropdown-toggle nav-link" data-toggle="dropdown" href="products.php" role="button" aria-haspopup="true" aria-expanded="false">Product</a>
			  <div class="dropdown-menu">
				  ...
				  {
				  ?>
                    <a class="dropdown-item" href="<?php echo $row['href']?>"><?php echo $row['Name']?></a>
				<?php
				  }
				  ?>
				  </div>
    ...
    <div class="services">
      <div class="container">
        <div class="row">
		  ...
		  <?php
		  include "server.php";
		  $query="SELECT * FROM product where Catalog_ID =1";
		  $data=mysqli_query($conn,$query);
