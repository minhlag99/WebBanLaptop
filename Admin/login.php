...
if (isset($_POST['login'])) 
{
	...
	$queryy ="SELECT status FROM admin WHERE Name='$username'";
	...
	$query ="SELECT User_Name FROM admin WHERE User_Name='$username'";
	...
	$query1 ="SELECT Password FROM admin WHERE User_Name='$username'";
	...
	echo "<script>alert('Đăng nhập thành công');window.location.href='Table.php';</script>";
    die();
}
?>
<!DOCTYPE html>
